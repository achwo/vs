...
########################################################################################################
dataSource="ressourcen/datasource/datasource/DataSource"
...
########################################################################################################
stationCmd="erl -noshell -pa bin -s station start $interfaceName $mcastAddress $receivePort $stationClass $UTCoffsetMs"
